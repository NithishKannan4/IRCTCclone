...
def check_seat_availabilty(flag = ''):
	src = input("Enter the source station code:- ")
	des = input("Enter the destination station code:- ")
	flag_2 = 0
	for i in trains:
...
t1 = train('Nilgiris',12345,'12:34','22:12','cbe','mas','Wed',30,23,43,2205,320,234)
t2 = train('Island',12565,'02:34','23:12','cbe','sbc','Mon',33,4,12,3434,435,234)
t3 = train('Shatabthi',22353,'11:56','03:12','mas','sbc','Fri',33,24,77,455,325,533)
trains = {t1.num:t1,t2.num:t2,t3.num:t3}
u1 = user(1234,'Nithish','Coimbatore','789456123','Nithish4')
users={u1.uid : u1}
ticket_dict = {}
